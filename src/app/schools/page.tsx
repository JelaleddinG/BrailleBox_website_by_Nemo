    ...
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20 lg:px-10">
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-[2rem] border border-black/8 p-8"><h2 className="text-2xl font-semibold">Modern assistive technology</h2><p className="mt-4 text-slate-600 leading-7">A product experience that feels built for today, not inherited from the past.</p></div>
