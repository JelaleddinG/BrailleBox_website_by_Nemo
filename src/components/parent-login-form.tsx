...
export function ParentLoginForm() {
  ...
  const [email, setEmail] = useState("parent@test.edu");
    ...
    <form onSubmit={onSubmit} className="space-y-5">
      <div>
        ...
        <input
          ...
          type="email"
          className="w-full rounded-2xl border border-white/12 bg-white/95 px-4 py-3 text-slate-950 outline-none transition focus:border-[var(--bb-orange)]"
          required
        />
      </div>
      <div>
        ...
        <div className="flex overflow-hidden rounded-2xl border border-white/12 bg-white/95">
          ...
          <button
            ...
            className="px-4 text-sm font-medium text-slate-500 transition hover:text-[var(--bb-orange)] hover:underline"
          >
